...
values except for initial X to ensure no lines drawn.
                dragging = false;
...
Buttons, change the color to the one selected
                ...
                if (X <= (width/5)+5 ){ System.out.println("RESET");
choosepaint = 5;}
                if (X <= 2*width/5+9 && X >
width/5+6){System.out.println("Color is Red"); choosepaint
= 1;}
                if (X <= 3*width/5+11 && X > 2*width/5+9){
System.out.println("Color is blue"); choosepaint = 2;}
                if (X <= 4*width/5+13 && X > 3*width/5+11){
System.out.println("Color is gray"); choosepaint = 3;}
                if (X > 4*width/5+13){ System.out.println("Color is
green"); choosepaint = 4;}
